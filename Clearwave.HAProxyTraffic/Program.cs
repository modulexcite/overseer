    ...
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            var samples = new[] {
                ...
                @"<165>Apr 10 08:09:20 atl-lb01.prod.clearwaveinc.com haproxy[13927]: 72.242.47.171:55828 [10/Apr/2015:08:09:20.647] http-web~ http-web/atl-web01 27/0/0/1/28 304 114 - - ---- 932/918/3/1/0 0/0 {Mozilla/5.0 (compatible; MSIE 10.0; Windows NT 6.1; WOW64; Trident/6.0)|secure.clearwaveinc.com|} {||||} ""GET /v2.5/ProviderPortal/static/images/logout.png?r=0 HTTP/1.1""",
                ...
                @"<165>Apr 10 08:09:20 atl-lb01.prod.clearwaveinc.com haproxy[13927]: 216.52.192.177:55956 [10/Apr/2015:08:09:11.185] http-web~ http-web/atl-web02 9452/0/0/51/9503 200 382 - - ---- 932/918/1/2/0 0/0 {Mozilla/5.0 (compatible; MSIE 10.0; Windows NT 6.1; WOW64; Trident/6.0)|secure.clearwaveinc.com|} {||||} ""GET /v2.5/ProviderPortal/PortalMessages/PortalMessages?_=1428667760655 HTTP/1.1""",
                @"<165>Apr 10 13:40:03 atl-lb01.prod.clearwaveinc.com haproxy[13927]: 66.18.123.30:60977 [10/Apr/2015:13:39:53.133] http-web~ http-web/atl-web01 10031/0/1/25/10057 200 354 - - ---- 2035/2013/16/9/0 0/0 {Mozilla/5.0 (compatible; MSIE 9.0; Windows NT 6.1; WOW64; Trident/5.0)|secure.clearwaveinc.com|} {||||} ""GET /v2.5/ProviderPortal/VisitList/RefreshTabs?date=Fri+Apr+10+2015&fetchMultipleLocations=false&_=1428687603469 HTTP/1.1""",
